...
class Server extends ProcessServerAbstract {
	...
	protected function checkSetting() {
		$this->connection['worker_num'] = $this->connection['worker_num'] ?? 1;
		++$this->connection['worker_num'];
	...
	protected function register() {
		...
		$this->pool->registerProcess('crontab_executor', ExecutorProcess::class, $setting['worker_num'] - 1);
	}
}
